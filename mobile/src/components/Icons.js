// SVG icon set — consistent single-weight line icons instead of emoji.
// All 24×24 viewBox, 1.8 stroke, round caps.

import React from 'react';
import Svg, { Circle, Line, Path, Rect } from 'react-native-svg';

const S = ({ children, size, color }) => (
...
export const BoltIcon = ({ size = 22, color = '#fff', filled = false }) => (
...
export const ChatIcon = ({ size = 22, color = '#fff' }) => (
...
export const ChartIcon = ({ size = 22, color = '#fff' }) => (
  <S size={size} color={color}>
...
export const SettingsIcon = ({ size = 22, color = '#fff' }) => (
  <S size={size} color={color}>
...
export const SunIcon = ({ size = 22, color = '#fff' }) => (
  <S size={size} color={color}>
...
export const BatteryIcon = ({ size = 22, color = '#fff' }) => (
  <S size={size} color={color}>
...
export const PlugIcon = ({ size = 22, color = '#fff' }) => (
  <S size={size} color={color}>
    {/* Plug: two prongs + body + cord */}
...
export const LeafIcon = ({ size = 22, color = '#fff' }) => (
  <S size={size} color={color}>
...
export const BellIcon = ({ size = 22, color = '#fff' }) => (
  <S size={size} color={color}>
